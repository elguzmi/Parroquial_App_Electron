/*
  Product SP: BD_Invt_MinistrosDoyFe
  Repeatable migrator: CREATE OR ALTER (checksum)
*/
/****** Object:  StoredProcedure [dbo].[BD_Invt_MinistrosDoyFe]    Script Date: 9/3/2026 5:02:48 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[BD_Invt_MinistrosDoyFe]
@Id int
AS
BEGIN
	BEGIN TRY
